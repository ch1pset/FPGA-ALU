...
HD_PWD='C:/Users/Josh/Programming/Projects/verilog/FPGA-ALU/FPGA-ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DISP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DISP.tcl -notrace
