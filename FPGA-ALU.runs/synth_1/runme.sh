...
HD_PWD='C:/Users/Josh/Programming/Projects/verilog/FPGA-ALU/FPGA-ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DISP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DISP.tcl
